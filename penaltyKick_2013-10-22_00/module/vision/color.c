...
const ColorBoundary blue_B = {180, 250, 40, 100, 40, 100};
const ColorBoundary red_B = {345, 15, 45, 100, 56, 100};
const ColorBoundary yellow_B = {50, 76, 50, 100, 81, 100};
//const ColorBoundary green_B = {155, 170, 50, 100, 30, 100};	이전거
const ColorBoundary green_B = {120, 160, 50, 100, 20, 100};	//fira에서
const ColorBoundary flourscencegreen_B = {55, 105, 30, 100, 30, 100};	// 백업
//const ColorBoundary flourscencegreen_B = {55, 120, 50, 90, 30, 100};
